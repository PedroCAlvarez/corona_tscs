---
title: "CoronaNet COVID-19 Government Response Event Database"
header-includes:
   - \usepackage{lineno}
   - \linenumbers
csl: nature.csl
...
-->
We present a dataset which does not only support real-time research on condemnment strategies or social, economic, and political consequences of COVID-19. The data will moreover allow to learn from this pandemic in future crises. Given its dyadic structure (e.g. target countries of border restrictions), the dataset does further enable spatial analyses to identify (inter-)related reactions between and within countries or identify conflictious andcooperative patterns in global crisis governance.
