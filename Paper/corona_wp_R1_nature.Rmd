...
At the time of writing, we are in the process of completing our second coding of the validation sample. Thus far, 285 policies have been double coded---265 double-coded policies after excluding the category 'Other policies' from the analysis---out of the original 500 randomly-selected policies included in our validation set. This is equivalent to the 10\% of the first 5,000 policies in the dataset, although will be gradually expand the validation set until we cover all observations. To evaluate the inter-coder reliability at this early stage of validation, we provide several measures in Table \ref{tab:validation}. We find remarkable heterogeneity in the inter-coder reliability across types of policies. Our coders show a high level of agreement on policies such as 'Restrictions of Mass Gatherings', 'Closure of Schools', 'Restrictions of Non-Essential' and 'External Border Restrictions'. However, the inter-rater agreement score remains poor for some policies such as 'Social Distancing', 'New Task Force, Bureau or Administrative Configuration' and 'Public Awareness Measures'. Further, we detect substantial disagreements across the different health-related measures: health resources (n = 34, k = 0.69), health testing (n = 7, k = 0.08), and health monitoring (n = 10, k = 0.14). Hence, we decide to combine them under the category of 'Health measures' in this on-going validation. Overall, these statistics indicate substantial levels of overall agreement between coders with inter-coder reliability scores above 0.70, although we also acknowledge that there remain some ambiguities providing evidence for the utility of our planned ``majority voting'' validation strategy.
