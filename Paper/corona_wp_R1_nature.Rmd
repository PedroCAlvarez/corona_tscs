...
overall + breakout +
  plot_annotation(tag_levels="A",
                  caption=str_wrap("Estimates are derived from Stan, a Markov Chain Monte Carlo sampler. Uncertainty intervals are not shown. Plot A shows the full distribution of countries, while plot B shows each month separately with the top 4 countries for that month in terms of increases in activity scores from start of the month to the end of the month.",width=120))
