...
```{r modelconv,fig.cap="Rhat Values of Parameters for Random-Walk MCMC Fit"}
...
# 
# ggsave("mcmc_evaluate.png")

knitr::include_graphics("mcmc_evaluate.png")
