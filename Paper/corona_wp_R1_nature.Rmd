...
```{r plotvar,fig.height=11,fig.width=5}
# severity_fit <- readRDS("../data/activity_fit_rw.rds")
# 
# all_lev <- as.character(unique(clean_data$init_country))
# 
...
get_var %>% 
  ...
  geom_pointrange(aes(ymin=low_est2,
                      ymax=high_est2)) +
  theme(panel.grid = element_blank(),
        panel.background = element_blank(),
...
\hline
                      & \textbf{Scott's Pi} & \textbf{Krippendorf's Alpha} & \textbf{Fleiss' Kappa} & \textbf{Cohen's Kappa} & \textbf{Percentage Agreement} \\ \hline
\textbf{Estimate}     & 0.513               & 0.514                        & 0.513                  & 0.577                  & 0.610                         \\ \hline
\textbf{Std. Error}   & 0.040               &                              &                        &                        &                               \\ \hline
\textbf{Coders}       & 2                   & 2                            & 2                      & 2                      & 2                             \\ \hline
\textbf{Observations} & 192                 & 192                          & 192                    & 192                    & 192                           \\ \hline
\end{tabular}%
}
\end{table}
