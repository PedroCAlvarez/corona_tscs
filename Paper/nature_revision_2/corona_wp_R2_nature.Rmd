...
clean_data %>% 
  ...
  xlab("") +
  facet_wrap(~type)
ggsave("Figure1.jpg",height=225,width=180,units="mm")
...
ggsave("Figure2.jpg", height = 115, width = 88, units = 'mm')
``` 
...
ggsave("Figure3.jpg", width = 180, height = 225, units = 'mm')
...
ggsave("Figure4.jpg", width = 180, height = 220, units = 'mm')
...
set.seed(2)
get_var$select = ifelse(1:194 %in% unique(c(1, sample(1:194, 90))), 1, 0)
...
get_var %>% 
  ...
  geom_text_repel(
    ...
    aes(label=country),size=3,force=1.8,segment.alpha=0.5,hjust=1) +
  theme(panel.grid = element_blank(),
        panel.background = element_blank(),
...
ggsave("Figure5.jpg", width = 180, height = 240, units = 'mm')
